<%@page import="com.briup.youyu.bean.Book"%>
...
<body>
	...
	<div class="header3">
		...
		<div class="h3_right">
			<div class="myyy">
				<a href="userInfo.jsp"> 个人信息 <span class="sj_down"></span>
				</a>
			</div>
			<div class="tsc">
		...
		<div class="cn5_top">
			...
			<div class="cn5_top_y center01">
				...
				<%
					...
					Map<Long, Book> map = (Map<Long, Book>) application.getAttribute("allBooks");
					Book b = map.get(id);
				...
				<div class="cn5topy_2">
					...
					<form action="addToCart.action" method="post">
						...
						<div class="pro_buy">
							...
							<div>
								<input type="submit" value="加入购物车" class="pro_addshop"
									style="border: 0px;">
							</div>
						</div>
					</form>
